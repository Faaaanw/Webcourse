          ...
          <Row className="header-box d-flex align-items-center">
            <Col lg="6">
              ...
              <p className="mb-4 animate__animated animate__fadeInUp animate__delay-1s">
                Lorem ipsum dolor sit amet consectetur adipisicing elit. Aperiam in eaque minus voluptatibus error dolores vel
                impedit consectetur reprehenderit soluta corporis esse eveniet quo 
                beatae laborum, quisquam, vero, quia sint!
              </p>
